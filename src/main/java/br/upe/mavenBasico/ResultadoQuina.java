...
public class ResultadoQuina {
    private final static String URL = "http://loterias.caixa.gov.br/wps/portal/loterias/landing/quina/";
    ...
    public static List<String> pegarResultado() {
    ...
    private static List<String> obterResultado(WebDriver driver) {
